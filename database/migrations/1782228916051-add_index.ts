...
export class AddIndex1782228916051 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE INDEX CONCURRENTLY idx_orders_created_item ON orders (created_at, item_id);'
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX CONCURRENTLY IF EXISTS idx_orders_created_item;`);
  }
}
